    ...
    <div class="${styles["page-wrapper"]}">
      <div class="${styles["container"]}">
        ...
        <div class="${styles["content"]}">
          <h1 class="${styles["content-h1"]}">404</h1>
          <h2 class="${styles["content-h2"]}">PAGE NOT FOUND</h2>
          <p class="${styles["content-p"]}">
            Oops! We can’t seem to find the page you’re looking for.
            Try going back to the previous page.
          </p>

          <button class="${styles["content-button"]}">
            <a href="/" class="${styles["content-button-a"]}">  
              Go Back
            </a>
          </button>
        </div>
        ...
        <img
          class="${styles["image-container-img"]}"
